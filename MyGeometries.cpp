...
const int itriFlag2 = 5;
const int itriFlag3 = 6;
const int itriFlag4 = 7;

const unsigned int aPos_loc = 0;		// Corresponds to location = 0 in the vertex shader definitions
const unsigned int aColor_loc = 1;		// Corresponds to location = 1 in the vertex shader definitions
...
void MyRenderGeometries() {
    ...
    glBindTexture(GL_TEXTURE_2D, TextureNames[10]);     // Choose Brick wall texture
    ...
    matDemo.Mult_glTranslate(0, .1, 0.4);
